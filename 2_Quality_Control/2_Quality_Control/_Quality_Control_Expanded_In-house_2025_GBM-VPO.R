###############################################################################
# Script:       Quality Control - Expanded in-house dataset
...
setwd("H:/.shortcut-targets-by-id/1VEKPzB1T9K_ZyE4xteiwNQa0Tpa34pXh/_Projeto_Pi_Fapesp_2022/2c_WGCNA_proteomic_transcriptomic_inHouse/_Victoria_Paiva/analises/2_expanded_set/")
...
samples_to_keep <- c(
  "E0155.0", "E0155.05", "E0155.10", "E0155.20", "E0155.50", 
  "E3060.0", "E3060.05", "E3060.10", "E3060.20", "E3060.50",
  "E3732.0", "E3732.05", "E3732.10", "E3732.20", "E3732.50", 
  "E4915.0", "E4915.05", "E4915.10", "E4915.20", "E4915.50"
)
...
# Metrics: Batch Correction p-value Threshold: 0.6;  k Value: 5
...
clinical_subset = as.data.frame(clinical[, c(24,26:30)])
