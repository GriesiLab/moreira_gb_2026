...
expData <- read.csv("Type_1_Studies/Anjos-Afonso_etal_2021/DATA/counts_WGCNA_final.csv")
...
writeXStringSet(promoter_seqs, "Type_1_Studies/Anjos-Afonso_etal_2021/RESULTS/Transcription _Factor/promoters_foreground.fa")
...
writeXStringSet(promoter_seqs_bg, "Type_1_Studies/Anjos-Afonso_etal_2021/RESULTS/Transcription _Factor/promoters_background.fa")
...
# ---------------- Save outputs ----------------
# Main results
outdir_jas <- "Type_1_Studies/Anjos-Afonso_etal_2021/RESULTS/Transcription _Factor"
