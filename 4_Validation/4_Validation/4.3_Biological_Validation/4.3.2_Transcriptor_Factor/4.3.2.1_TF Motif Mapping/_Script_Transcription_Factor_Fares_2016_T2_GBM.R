...
expData <- read.csv("Type_2_Studies/Fares_2017/DATA/counts_NonNormalized.csv")
...
writeXStringSet(promoter_seqs, "Type_2_Studies/Fares_2017/RESULTS/Transcription _Factor/promoters_foreground.fa")
...
writeXStringSet(promoter_seqs_bg, "Type_2_Studies/Fares_2017/RESULTS/Transcription _Factor/promoters_background.fa")
...
# ---------------- Save outputs ----------------
# Main results
outdir_jas <- "Type_2_Studies/Fares_2017/RESULTS/Transcription _Factor"
