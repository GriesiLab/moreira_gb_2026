...
expData <- read.csv("Type_1_Studies/Xie_etal_2019/DATA/counts_NonNormalized.csv")
...
writeXStringSet(promoter_seqs, "Type_1_Studies/Xie_etal_2019/RESULTS/Transcription _Factor/promoters_foreground.fa")
...
writeXStringSet(promoter_seqs_bg, "Type_1_Studies/Xie_etal_2019/RESULTS/Transcription _Factor/promoters_background.fa")
...
# ---------------- Save outputs ----------------
# Main results
outdir_jas <- "Type_1_Studies/Xie_etal_2019/RESULTS/Transcription _Factor"
