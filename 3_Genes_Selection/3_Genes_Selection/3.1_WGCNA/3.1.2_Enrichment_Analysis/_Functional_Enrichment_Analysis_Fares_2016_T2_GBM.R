###############################################################################
# Script:        Functional Enrichment GO BP WGCNA Modules Fares
...
#     and generate a dotplot panel summarizing top GO terms per module.
#
# Deliverables:
...
#
# Inputs:
#   - DATA/counts_Final.csv        (gene universe; first column must be Ensembl)
...
run_enrichment_analysis(
  ...
  selected_modules   = c("brown", "yellow"),
  ontology           = "BP",
  p_value_cutoff     = 0.05,
  min_gene_set_size  = 10,
  max_gene_set_size  = 500,
