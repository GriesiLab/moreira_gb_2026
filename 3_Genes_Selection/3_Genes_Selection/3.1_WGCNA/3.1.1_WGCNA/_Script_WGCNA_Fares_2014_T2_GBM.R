###############################################################################
# Script:        WGCNA Fares 2016
# Author:        Gustavo Bueno Moreira
# Last update:   2026-02-16
#
# Purpose:
#   - Run WGCNA on variance-stabilized RNA-seq counts for the Fares (2017)
#     dataset (fresh/uncultured cells), generating network modules, kME tables,
#     module eigengenes, and module-trait correlation summaries and plots.
#
# Deliverables:
...
plot <- ggplot(df_lt, aes(x = Correlation, y = NegLog10FDR_plot, fill = Module, color = Module)) +
  ...
  labs(
    title = "Correlation of Eigengenes with LT-HSC samples - Fares",
